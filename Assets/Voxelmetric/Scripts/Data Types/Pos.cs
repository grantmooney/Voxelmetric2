...
public struct Pos {
    ...
    public override bool Equals(object obj)
    {
        ...
        var p = obj as Pos?;
        // If p is not null and the fields match, return true. Otherwise, return false
        return (p.HasValue) ? ((x == p.Value.x) && (y == p.Value.y) && (z == p.Value.z)) : false;
    }
