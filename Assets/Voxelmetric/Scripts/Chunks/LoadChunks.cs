...
public class LoadChunks : MonoBehaviour
{
    ...
    protected ChunkController chunks;

    void Start()
    {
        chunks = vm.components.chunks;
        Debug.Log(chunks.ToString());
    ...
    protected virtual void DeleteChunks()
    {
        var posX = objectPos.x;
        var posZ = objectPos.z;
